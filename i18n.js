...
const STRINGS = {
  ja: {
    ...
    languageHint: '既定はブラウザの言語（{browser}）です。要約文と、この画面やボタンの表示が切り替わります。',
    lengthLabel: '要約の長さ',
  ...
  en: {
    ...
    languageHint: 'Defaults to your browser language ({browser}). Changes both the summary text and this interface.',
  ...
  zh: {
    ...
    languageHint: '默认使用浏览器语言（{browser}）。摘要正文和本界面都会随之切换。',
    lengthLabel: '摘要长度',
    lengthHint: '每次生成的内容量。',
    lengthShort: '简短',
    lengthMedium: '适中',
